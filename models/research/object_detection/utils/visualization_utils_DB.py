...
#from utils import sqliteDatabase as sqlite
    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          ...
          c.execute("SELECT details FROM FruitsList WHERE fname = '"+class_name+"' ")
          #c.execute("SELECT details FROM FruitsList WHERE fname = 'mango' ")
