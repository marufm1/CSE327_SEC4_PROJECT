...
# Directories
train_directory = './images/banana/train' # It should contain the xml files with bounding boxes
test_directory = './images/banana/test' # It should contain the xml files with bounding boxes
